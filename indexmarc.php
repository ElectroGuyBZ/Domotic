...
switch ($rcmd) {
  ...
  break;
     case "OFF1":
        $fp =fopen($comPort, "ab");
		$date = date('d m Y H:i:s');
  fwrite($fp, $date.">3.$.S2N2.S0N1.RELAY1OFF.#\n"); /* this is the number that it will write */
  fclose($fp);
  $Image1Open = fopen($Image1, "ab");
  ftruncate($Image1Open, 0);
  ...
  case "ON2":
        $fp =fopen($comPort, "ab");
		$date = date('d m Y H:i:s');
  fwrite($fp, $date.">3.$.S2N2.S0N1.RELAY2ON.#\n"); /* this is the number that it will write */
  fclose($fp);
  ...
  case "OFF2":
       $fp =fopen($comPort, "ab");
		$date = date('d m Y H:i:s');
  fwrite($fp, $date.">3.$.S2N2.S0N1.RELAY2OFF.#\n"); /* this is the number that it will write */
  fclose($fp);
  $Image2Open = fopen($Image2, "ab");
  ftruncate($Image2Open, 0);
...
case "ON3":
        $fp =fopen($comPort, "ab");
		$date = date('d m Y H:i:s');
  fwrite($fp, $date.">3.$.S2N2.S0N1.RELAY3ON.#\n"); /* this is the number that it will write */
  fclose($fp);
...
case "OFF3":
        $fp =fopen($comPort, "ab");
		$date = date('d m Y H:i:s');
  fwrite($fp, $date.">3.$.S2N2.S0N1.RELAY3OFF.#\n"); /* this is the number that it will write */
  fclose($fp);
  $Image3Open = fopen($Image3, "ab");
  ftruncate($Image3Open, 0);
...
<div class="container">
<center> 
<img src="/title.jpg" alt="Domotic" width="680" height="112">    
<br> 
    ...
    <br><br\> 
<br> 
	<img src="<?php echo $statSocket3; ?>" alt="SOCKET" width="230" height="232">
    ..
	<img src="<?php echo $statSocket1; ?>" alt="SOCKET" width="230" height="232">
    ..
	<img src="<?php echo $statSocket2; ?>" alt="SOCKET" width="230" height="232">
    <br\> 
    <br> 
